//many thanks tohttps://observablehq.com/@d3/treemap/2?intent=fork
    ...
    constructor(params) {
        ...
        this.init = function () {
            root = d3.stratify()
                ...
                (me.items.filter(d=>{
                    d.value = d["dcterms:description"] ? d["dcterms:description"][0]["@value"].length : 1;
        ...
        function render(group, root) {
            ...
            node.append("text")
              ...
              .data(d => (d === root ? name(d) : d.data['o:title']).split('*').concat(format(d.value)))
              .join("tspan")
                .attr("x", 3)
