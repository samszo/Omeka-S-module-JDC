...
class JDCphysiques extends AbstractBlockLayout
{
    /**
     * The default partial view script.
     */
    const PARTIAL_NAME = 'common/block-layout/JDCphysiques';

    public function getLabel()
    {
        return 'JDC physiques'; // @translate
    }
    ...
    public function form(
        ...
        $html = '<p>'
            . $view->translate('Un block pour jardiner des dimensions physiques.') // @translate
            . '</p>';

        $blockFieldset = \JDC\Form\ConfigFormPhysiques::class;
